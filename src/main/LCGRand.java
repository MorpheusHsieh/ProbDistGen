...
{
	public static final int MODLUS = 2147483647;
	public static final int MULT1 =  24112;
	public static final int MULT2 =  26143;
	public static final int MAX_STREAMS = 100;
	
	private static final int zrng[] =
	{     1,
	 ...
	 * 建構元函數
	 */
//	public LCG() { this._Rand.setSeed(System.currentTimeMillis()); }
	...
	public static void lcgrandst (int zset, int stream) 
  {
    zrng[stream] = zset;
  }
	
	/* Return the current zrng for stream "stream". */
  public static int lcgrandgt (int stream) 
  {
    return zrng[stream];
  }
